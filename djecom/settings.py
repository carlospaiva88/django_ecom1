...
SECRET_KEY = "django-insecure-43ybmpv+cj6*0ra-8j1mhaoy3s6s0(3#iuhh0c$8x(%dp%4a4#"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "store.context_processors.media_url"
            ],
        },
    },
]
...
PAYPAL_RECEIVER_EMAIL = 'raulseixas@gmail.com' # business sandbox account